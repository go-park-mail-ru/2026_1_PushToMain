...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/drafts": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Кол-во записей (default 20, max 100)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.GetDraftsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateDraftRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handler.DraftResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Список ID черновиков",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateDraftRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.GetMyEmailsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/emails/unspam": {
            "put": {
                ...
                "description": "Снимает is_spam с указанных писем (только там, где текущий юзер — получатель)\nи удаляет соответствующих отправителей из персонального списка spam_senders.\nНа остальные письма этих же отправителей, ранее помеченные спамом, не влияет —\nони остаются в спаме до явного вызова unspam с их id.",
                "consumes": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateNewFolderRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handler.CreateNewFolderResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.AddEmailsInFolderRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.DeleteEmailsFromFolderRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ChangeFolderNameRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_go-park-mail-ru_2026_1_PushToMain_internal_app_email_delivery_http.EmailResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "github_com_go-park-mail-ru_2026_1_PushToMain_internal_app_email_delivery_http.EmailResponse": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string"
        ...
        "github_com_go-park-mail-ru_2026_1_PushToMain_internal_app_folder_delivery_http.EmailResponse": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string"
        ...
        "handler.ChangeFolderNameRequest": {
            "type": "object",
            "properties": {
                "folder_name": {
                    "type": "string"
        ...
        "handler.CreateNewFolderRequest": {
            "type": "object",
            "properties": {
                "folder_name": {
                    "type": "string"
        ...
        "handler.CreateNewFolderResponse": {
            "type": "object",
            "properties": {
                "folder_id": {
                    "type": "integer"
        ...
        "handler.GetEmailsFromFolderResponse": {
            "type": "object",
            "properties": {
                "emails": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_go-park-mail-ru_2026_1_PushToMain_internal_app_folder_delivery_http.EmailResponse"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "handler.GetMyEmailsResponse": {
            "type": "object",
            "properties": {
                "emails": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handler.MyEmailResponse"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "http.UpdateProfileRequest": {
            ...
            "properties": {
                "birthdate": {
                    "description": "ISO-8601 формат 2000-02-20",
                    "type": "string"
                },
                "is_male": {
                    "type": "boolean"
